...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=.3\linewidth]{images/quicktime_bar.png}
            \includegraphics[width=.3\linewidth]{images/quicktime_lock.png}
        \end{figure}
    \end{itemize}
...
\begin{figure}[H]
	\includegraphics[width=\linewidth]{images/controllerlayout.jpg} %TODO: Add real control mapping
...
\begin{figure}
    \centering
    \includegraphics{images/Drone-Concept.png}
\end{figure}

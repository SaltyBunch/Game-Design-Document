...
\title{\includegraphics[width=.6\linewidth]{images/logo.jpg}\\\textbf{Game Design Document}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.75\linewidth]{images/Ground2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.75\linewidth]{images/Basement2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.75\linewidth]{images/BasementPathing02.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.75\linewidth]{images/BasementDrone.png}
...
\begin{figure}[H]
    \centering
	\includegraphics[width=.8\linewidth]{images/tripWireVault.png}
    \caption{Trip Wires Outside Vault}
\end{figure}

\begin{figure}[H]
    \centering
	\includegraphics[width=.8\linewidth]{images/lobbyAlert.png}
...
\begin{minipage}{.18\linewidth}
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth]{images/drone_fac2e.jpg}
        \caption{Drone}
    \end{figure}
\end{minipage}
\begin{itemize}
...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.8\linewidth]{images/buttonprompt.jpg}
    ...
    \begin{itemize}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[height=15pt]{images/quicktime_bar.png}
            \includegraphics[height=35pt]{images/quicktime_lock.png}
...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.6\linewidth]{images/insidebank.jpg}
...
\begin{minipage}{.13\linewidth}
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth]{images/HeartUI.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.7\linewidth]{images/gameflowsummary.jpg}
    \caption{Game Flow}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\linewidth]{images/options_menu.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\linewidth]{images/thumbnail.jpg}
    \caption{Pause Menu}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\linewidth]{images/CutScene.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\linewidth]{images/room.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.4\linewidth]{images/CharacterSelection1.JPG}
    \includegraphics[width=.4\linewidth]{images/CharacterSelection2.JPG}
    \includegraphics[width=.4\linewidth]{images/CharacterSelection3.JPG}
    \includegraphics[width=.4\linewidth]{images/CharacterSelection4.JPG}
...
\begin{figure}[H]
    \centering
	\includegraphics[width=.7\linewidth]{images/Zain_ControllerLayout.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.5\linewidth]{images/Drone-Concept.png}
...
\begin{center} %TODO: get updated list
    \begin{tabular}{| p{.45\linewidth} | p{.45\linewidth} |}
        \hline
...
\begin{figure}[H]
	\includegraphics[width=\linewidth]{images/electricfield1.png}
...
\begin{figure}[H]
    \centering
	\includegraphics[width=.6\linewidth]{images/portraits.png}
...
\begin{figure}[H]
    \centering
	\includegraphics[width=.8\linewidth]{images/renderVault1.png}
    \caption{Render of Vault Concept}
\end{figure}

\begin{figure}[H]
    \centering
	\includegraphics[width=.8\linewidth]{images/renderVault2.png}
    \caption{Render of Vault Concept}
\end{figure}

\begin{figure}[H]
    \centering
	\includegraphics[width=.8\linewidth]{images/renderLobby.png}
    \caption{Render of Lobby}
\end{figure}

\begin{figure}[H]
    \centering
	\includegraphics[width=.8\linewidth]{images/tellerscolour.jpg}
    \caption{Bank --- Main Lobby}
\end{figure}

\begin{figure}[H]
    \centering
	\includegraphics[width=.8\linewidth]{images/tellerscolourDRONE.jpg}
...
\begin{figure}[H]
    \centering
	\includegraphics[width=.8\linewidth]{images/nudes.png}
    \caption{Concept Render of Basement Hallway}
\end{figure}

\begin{figure}[H]
    \centering
	\includegraphics[width=.8\linewidth]{images/game_view.png}
    \caption{Concept Render of Area Around Vault}
\end{figure}
